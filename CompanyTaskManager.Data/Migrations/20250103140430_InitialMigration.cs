    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Projects_WorkStatuses_WorkStatusId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TaskItems_WorkStatuses_WorkStatusId",
                        column: x => x.WorkStatusId,
                        principalTable: "WorkStatuses",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "4b0b2aeb-474e-45f2-8899-e4a1536a52bf", 0, "0414581e-615c-46d2-b196-a30111135f83", "admin@localhost.com", true, "Default", "Admin", false, null, "ADMIN@LOCALHOST.COM", "ADMIN@LOCALHOST.COM", "AQAAAAIAAYagAAAAEHJKXZkV77GZAEIhBBs2Q+ykkV7yeNqLtyhVLN9N/vr7qF56WijkDVABsUePKNovqg==", null, false, "ad228f87-f9f9-4e31-8042-e741c0798a18", null, false, "admin@localhost.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 9, "Project Completion Approve" },
                    { 10, "Project Completion Rejected" },
                    { 11, "Task Waiting For Approve" },
                    { 12, "Task Completion Approve" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskItems_WorkStatusId",
                table: "TaskItems",
                column: "WorkStatusId");
