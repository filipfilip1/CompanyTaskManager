...
public class ProjectServiceTests : ServiceTestBase
{
    ...
    public async Task GetProjectsByUserAsync_ShouldReturnUserProjects_AsManager()
    {
        ...
        var project1 = await DataBuilder.CreateProjectAsync(manager.Id, "Project 1", teamId: team.Id);
        var project2 = await DataBuilder.CreateProjectAsync(manager.Id, "Project 2", teamId: team.Id);
    ...
    public async Task GetProjectByIdAsync_ShouldReturnProjectDetails_WhenExists()
    {
        ...
        result.ManagerUserName.ShouldBe("manager");
        result.LeaderUserName.ShouldBe("leader");
